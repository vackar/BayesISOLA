...
inputs = BayesISOLA.load_data(
	outdir = 'output/example_2_SAC'
	)
inputs.read_event_info('input/example_2_SAC/event.isl')
...
inputs.load_files('input/example_2_SAC/sac/', separator='', pz_dir='input/example_2_SAC//pzfiles/', pz_separator='', pz_suffix='.pz')
